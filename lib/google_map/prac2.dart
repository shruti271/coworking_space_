...
//   static String routeName = "/allmap";
//   @override
...
//     super.initState();
//     geo = Geoflutterfire();
//     GeoFirePoint center = geo.point(latitude:21.2060, longitude:  72.8866);
//     stream = radius.switchMap((rad) {
//       var collectionReference = _firestore.collection('places');
//       //          .where('name', isEqualTo: 'darshan');
//       return geo.collection(collectionRef: collectionReference).within(center: center, radius: rad, field: 'location');
